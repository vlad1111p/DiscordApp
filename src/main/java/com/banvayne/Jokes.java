...
public class Jokes {
    ...
    public Jokes() {
        ...
        jokes.add(
                "i walked my dog to the park but it was attacked by ducks. that's what i get for buying a purebred\n");
        ...
        jokes.add("i decided to sell my vacuum. it was just collecting dust.\n");
